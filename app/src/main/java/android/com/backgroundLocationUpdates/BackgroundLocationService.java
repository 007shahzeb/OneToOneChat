...
//        LocationServices.FusedLocationApi.requestLocationUpdates(this.mGoogleApiClient, mLocationRequest, (com.google.android.gms.location.LocationListener) this); // This is the changed line.


        Intent intent1 = new Intent(this, LocationReceiver.class);
        PendingIntent pendingIntent = PendingIntent
                .getBroadcast(this, 54321, intent1, PendingIntent.FLAG_CANCEL_CURRENT);
        LocationServices.FusedLocationApi.requestLocationUpdates(this.mGoogleApiClient,
                mLocationRequest, pendingIntent); // This is the changed line.


//        Intent intent1 = new Intent(this, LocationReceiver.class);
//        locationIntent = PendingIntent.getBroadcast(getApplicationContext(), 14872, intent1, PendingIntent.FLAG_CANCEL_CURRENT);
